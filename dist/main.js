...
class Storage {
    ...
    getAllTodos() {
        ...
        allProjects.sort((a, b) => {
            return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.compareAsc)(new Date(a.dueDate), new Date(b.dueDate));
        });
    ...
    getTodaysTodos() {
        ...
        const todaysTodos = allTodos.filter((todo) => {
            return !(0,date_fns__WEBPACK_IMPORTED_MODULE_0__.compareAsc)((0,date_fns__WEBPACK_IMPORTED_MODULE_1__.startOfDay)(new Date(todo.dueDate)), currentDate);
        });
...
function displayProject(project) {
    ...
    todos.sort((a, b) => {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.compareAsc)(new Date(a.dueDate), new Date(b.dueDate));
    });
...
function isTodoRed(todo) {
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.isPast)(new Date(todo.dueDate)) ? "alert-danger" : "alert-secondary";
}
...
function createTodoElement(todo) {
    ...
    timeRemainingEl.innerHTML = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.formatRelative)(new Date(todo.dueDate), new Date());
